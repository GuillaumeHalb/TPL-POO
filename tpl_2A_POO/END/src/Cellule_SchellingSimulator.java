...
public class Cellule_SchellingSimulator extends CelluleSimulator {
	...
	for (int i = 0; i < this.cells_schelling.getLignes(); i++) {
		...
		//chaque maison est repéré par un entier,
		//définissant une couleur unique
		Color coul = new Color (255, 255, 255);
		//si la maison est vide (etatk=0), coul reste inchangé (blanc)
		if (etatk != 0) {
		    coul = new Color ((40*etatk) % 255,
				      (255-40*etatk) % 255,
				      (255-40*etatk) % 255);
		} 
